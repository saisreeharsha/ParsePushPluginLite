package com.saisreeharsha.ParsePushPluginLite;
...
/**
 * Created by Sai Sree Harsha on 18-02-2019.
 */

public class ParsePushPluginLiteReceiver extends ParsePushBroadcastReceiver {
    private static final String TAG = "com.saisreeharsha.ParsePushPluginLiteReceiver";
    /**
    ...
    protected void onPushReceive(Context context, Intent intent) {
        ...
        if (ParsePushPluginLite.isInForeground()) {
            //
            // relay the push notification data to the javascript
            ParsePushPluginLite.jsCallback(getPushData(intent));
        }
    }
...
//        resetCount(getNotificationTag(context, pnData));
        ...
        ParsePushPluginLite.jsCallback(getPushData(intent), "OPEN");
    }
}
